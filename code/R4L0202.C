...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=10,truck1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=10,truck1buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=10,truck4buf,XOR_PUT);
		putimage(drumx1,drumy1-=10,fcar5buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=10,truck4buf,XOR_PUT);     //dreum
			putimage(drumx1,drumy1-=10,fcar5buf,XOR_PUT);
			roadspeed(100);
...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx1,drumy1+=10,truck1buf,XOR_PUT);
		putimage(drumx,drumy+=10,truck4buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx1,drumy1+=10,truck1buf,XOR_PUT);     //dreum
			putimage(drumx,drumy+=10,truck4buf,XOR_PUT);
			roadspeed(100);
