...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=10,feulb,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=10,feulb,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=10,car2buf,XOR_PUT);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=10,car2buf,XOR_PUT);     //dreum
			putimage(drumx1,drumy1-=10,fcar5buf,XOR_PUT);
			roadspeed(100);
...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=10,bus1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=10,bus1buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy-=10,pfcar6buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy-=10,pfcar6buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<50;rac++)
{
		...
		{
		putimage(drumx,drumy+=10,car2buf,XOR_PUT);
		putimage(drumx1,drumy1+=10,bus1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,car2buf,XOR_PUT);
