...
//geting police car3 image enemy object**********************************************
pcar1();
...
for(rac=1;rac<=50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy-=15,fcar5buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy-=15,fcar5buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<=50;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=15,pcar4buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=15,pcar4buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<40;rac++)
{
		...
		{
		putimage(drumx,drumy+=15,truck1buf,XOR_PUT);
		putimage(drumx1,drumy1-=15,fcar5buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,truck1buf,XOR_PUT);
...
for(rac=1;rac<40;rac++)
{
		...
		fflush(stdin);
			...
			else if(drumx>carx && drumx<carx+75 || drumx+70>carx && drumx+70<carx+75)
			{
			if(drumy+148>=cary)
			{
			rac=3000;
...
for(rac=1;rac<40;rac++)
{
		if(kbhit())
		{
		putimage(drumx1,drumy1+=15,truck1buf,XOR_PUT);
		putimage(drumx,drumy+=15,truck4buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx1,drumy1,truck1buf,XOR_PUT);
		putimage(drumx,drumy,truck4buf,XOR_PUT);
	     ...
	     //		putimage(carx,cary,buff,XOR_PUT);
		  ...
		  //	putimage(carx,cary,buff,XOR_PUT);
			...
			putimage(carx+32,cary-24,fir,XOR_PUT);
			nosound();
			if(drumx1>carx && drumx1<carx+75 || drumx1+70>carx && drumx1+70<carx+75 || drumx>carx && drumx<carx+75 || drumx+70>carx && drumx+70<carx+75)
			{
			rac=1000;
			}
			}
		...
		else
		{
			...
			{
			putimage(drumx1,drumy1+=15,truck1buf,XOR_PUT);     //dreum
			putimage(drumx,drumy+=15,truck4buf,XOR_PUT);
			roadspeed(100);
			putimage(drumx1,drumy1,truck1buf,XOR_PUT);  //drum
			putimage(drumx,drumy,truck4buf,XOR_PUT);
			}

		fflush(stdin);
		}
			if(drumx1>carx && drumx1<carx+75 || drumx1+70>carx && drumx1+70<carx+75)
			{
			if(drumy1+168>=cary)
			{
			rac=3000;
