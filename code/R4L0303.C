...
for(rac=1;rac<40;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=15,truck1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=15,truck1buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<40;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=15,truck4buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=15,truck4buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<40;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=15,truck3buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=15,truck3buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<40;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy-=15,pfcar6buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy-=15,pfcar6buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<40;rac++)
{
		...
		{
		putimage(drumx,drumy+=15,truck3buf,XOR_PUT);
		putimage(drumx1,drumy1-=15,pfcar6buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,truck3buf,XOR_PUT);
...
for(rac=1;rac<40;rac++)
{
		...
		{
		putimage(drumx,drumy+=15,truck3buf,XOR_PUT);
		putimage(drumx1,drumy1+=15,car2buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,truck3buf,XOR_PUT);
