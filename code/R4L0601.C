...
//geting bus1 image enemy object
bus1();
area=imagesize(181,114,268,311);
bus1buf=malloc(area);
getimage(181,114,268,311,bus1buf);
putimage(181,114,bus1buf,XOR_PUT);
...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=25,feulb,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=25,feulb,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=25,car2buf,XOR_PUT);
		putimage(drumx1,drumy1-=25,fcar5buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,car2buf,XOR_PUT);
		putimage(drumx1,drumy1,fcar5buf,XOR_PUT);
	     ...
	     //		putimage(carx,cary,buff,XOR_PUT);
		  ...
		  //	putimage(carx,cary,buff,XOR_PUT);
			...
			putimage(carx+32,cary-24,fir,XOR_PUT);
			nosound();
			if(drumx>carx && drumx<carx+75 || drumx+72>carx && drumx+72<carx+75 || drumx1>carx && drumx1<carx+75 || drumx1+60>carx && drumx1+60<carx+75)
			{
			rac=1000;
			}
			}
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=25,car2buf,XOR_PUT);     //dreum
			putimage(drumx1,drumy1-=25,fcar5buf,XOR_PUT);
			roadspeed(100);
			putimage(drumx,drumy,car2buf,XOR_PUT);  //drum
			putimage(drumx1,drumy1,fcar5buf,XOR_PUT);
			}
		...
		fflush(stdin);
			...
			{
			if(drumy1>=cary && drumy1<=cary+136 || drumy1+137>=cary && drumy1+137<=cary+136)
			{
			rac=3000;
			coin-=1;
			coingrp(coin);
...
{
	      //bus1 fall  standerd bus               single bus in road
drumv=random(410);
	if(drumv>140)
	{
	 drumx=drumv;
...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=25,bus1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,bus1buf,XOR_PUT);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=25,bus1buf,XOR_PUT);     //dreum
			roadspeed(100);
			putimage(drumx,drumy,bus1buf,XOR_PUT);  //drum
			}
		...
		putimage(drumx1,drumy1,fcar5buf,XOR_PUT);
	     ...
	     //		putimage(carx,cary,buff,XOR_PUT);
		  ...
		  //	putimage(carx,cary,buff,XOR_PUT);
			...
			putimage(carx+32,cary-24,fir,XOR_PUT);
			nosound();
			if(drumx>carx && drumx<carx+75 || drumx+87>carx && drumx+87<carx+75 || drumx1>carx && drumx1<carx+75 || drumx1+60>carx && drumx1+60<carx+75)
			{
			rac=1000;
			}
			}
...
for(rac=1;rac<25;rac++)
{
		...
		fflush(stdin);
			...
			if(drumx>carx && drumx<carx+75 || drumx+60>carx && drumx+60<carx+75)
			{
			if(drumy>=cary && drumy<=cary+137 || drumy+136>=cary && cary+136<=cary+137)
			{
			rac=50;
			coin-=3;
			coingrp(coin);
...
for(rac=1;rac<25;rac++)
{
		...
		{
		putimage(drumx,drumy+=25,car2buf,XOR_PUT);
		putimage(drumx1,drumy1+=25,bus1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,car2buf,XOR_PUT);
		putimage(drumx1,drumy1,bus1buf,XOR_PUT);
	     ...
	     //		putimage(carx,cary,buff,XOR_PUT);
		  ...
		  //	putimage(carx,cary,buff,XOR_PUT);
			...
			putimage(carx+32,cary-24,fir,XOR_PUT);
			nosound();
			if(drumx>carx && drumx<carx+75 || drumx+72>carx && drumx+72<carx+75 || drumx1>carx && drumx1<carx+75 || drumx1+87>carx && drumx1+87<carx+75)
			{
			rac=1000;
			}
			}
