...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=25,pcar4buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=25,pcar4buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy-=25,fcar5buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy-=25,fcar5buf,XOR_PUT);     //dreum
			roadspeed(100);
		...
		putimage(drumx1,drumy1,fcar5buf,XOR_PUT);
	     ...
	     //		putimage(carx,cary,buff,XOR_PUT);
		  ...
		  //	putimage(carx,cary,buff,XOR_PUT);
			...
			putimage(carx+32,cary-24,fir,XOR_PUT);
			nosound();
			if(drumx>carx && drumx<carx+75 || drumx+80>carx && drumx+80<carx+75 || drumx1>carx && drumx1<carx+75 || drumx1+60>carx && drumx1+60<carx+75)
			{
			rac=1000;
			}
			}
		...
		putimage(drumx1,drumy1,fcar5buf,XOR_PUT);
	     ...
	     //		putimage(carx,cary,buff,XOR_PUT);
		  ...
		  //	putimage(carx,cary,buff,XOR_PUT);
			...
			putimage(carx+32,cary-24,fir,XOR_PUT);
			nosound();
			if(drumx>carx && drumx<carx+75 || drumx+66>carx && drumx+66<carx+75 || drumx1>carx && drumx1<carx+75 || drumx1+60>carx && drumx1+60<carx+75)
			{
			rac=1000;
			}
			}
