...
//geting car2 image enemy object**********************************************
car3();
area=imagesize(389,140,461,289);
car2buf=malloc(area);
getimage(389,140,461,289,car2buf);
putimage(389,140,car2buf,XOR_PUT);
...
//geting truck image enemy object**********************************************
truck1();
...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy+=25,truck1buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy+=25,truck1buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<25;rac++)
{
		if(kbhit())
		{
		putimage(drumx,drumy-=25,pfcar6buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		...
		else
		{
			...
			{
			putimage(drumx,drumy-=25,pfcar6buf,XOR_PUT);     //dreum
			roadspeed(100);
...
for(rac=1;rac<25;rac++)
{
		...
		{
		putimage(drumx,drumy+=25,truck3buf,XOR_PUT);
		putimage(drumx1,drumy1-=25,pfcar6buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,truck3buf,XOR_PUT);
...
for(rac=1;rac<25;rac++)
{
		...
		{
		putimage(drumx,drumy+=25,truck3buf,XOR_PUT);
		putimage(drumx1,drumy1+=25,car2buf,XOR_PUT);
		roadspeed(speed);
		fflush(stdin);
		ch=bioskey(0);
		putimage(drumx,drumy,truck3buf,XOR_PUT);
		putimage(drumx1,drumy1,car2buf,XOR_PUT);
